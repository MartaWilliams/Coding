...
//wypisz na tablicy liczby z zakresu 1-100 podzielne przez 3
// odwróć elementy tablicy [1,3,5] -> [5,3,1]

public class HomeWorkLoopsCheck {

    /* public static void main(String[] args) {
  int[] numbers = new int[] {0-100};
     for (int i =1; i<100; i++) {
         if (i%3==0)
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < numbers.length/2; i++) {
            ...
            numbers[numbers.length- 1-i] = temp; //1 numerss[3] = 3
